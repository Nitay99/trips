...
var _audioFrame = require("./modules/audio-frame");
...
var _featureSlider = require("./modules/sliders/feature-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _featureSlider.initFeatureSlider)();
  (0, _gallerySlider.initGallerySlider)();
  (0, _video.setPlayVideoClickHandler)();
  (0, _audioFrame.setPlayAudioClickHandler)();
...
},{"./modules/audio-frame":2,"./modules/form-validate/form":4,"./modules/menu":10,"./modules/modals/init-modals":11,"./modules/section-title":13,"./modules/sliders/feature-slider":14,"./modules/sliders/gallery-slider":15,"./modules/sliders/header-slider":16,"./modules/sliders/review-slider":17,"./modules/sliders/tours-slider":18,"./modules/sliders/training-slider":19,"./modules/video":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setPlayAudioClickHandler = void 0;
var audioFrame = document.querySelector('.audio-frame');
var buttonPlay = document.querySelector('.audio-frame__play-button');
...
var setPlayAudioClickHandler = function setPlayAudioClickHandler() {
  if (buttonPlay) {
    buttonPlay.addEventListener('click', createFrame);
  }
};
exports.setPlayAudioClickHandler = setPlayAudioClickHandler;
...
},{"../../utils/focus-lock":21,"../../utils/scroll-lock":24}],13:[function(require,module,exports){
"use strict";
...
exports.initFeatureSlider = void 0;
...
var initFeatureSlider = function initFeatureSlider() {
  // if (window.innerWidth > 1199) {
  _swiper.default.use([_swiper.Grid, _swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default('.features__slider', {
    // Optional parameters
...
// }
// };
exports.initFeatureSlider = initFeatureSlider;
...
var initHeaderSlider = function initHeaderSlider() {
  ...
  // eslint-disable-next-line
  var swiper = new _swiper.default('.hero__slider', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    // If we need pagination
