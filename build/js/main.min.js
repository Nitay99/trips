...
var headerBackgrounds = document.querySelectorAll('.main-header__bg');
var headerRowHeight = document.querySelector('.main-header__row').clientHeight;
var headerWidth = document.querySelector('.main-header').offsetWidth;
if (headerBackgrounds.length >= 1) {
  headerBackgrounds.forEach(function (headerBg) {
    headerBg.style.height = "calc(100% + ".concat(headerRowHeight, "px)");
