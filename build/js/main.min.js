...
var _toursSlider = require("./modules/sliders/tours-slider");
var _trainingSlider = require("./modules/sliders/training-slider");
var _reviewSlider = require("./modules/sliders/review-slider");
require("./modules/sliders/feature-slider");
var _gallerySlider = require("./modules/sliders/gallery-slider");
var _map = require("./modules/map");
require("./modules/nav-link");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _toursSlider.initTourSlider)();
  (0, _trainingSlider.initTrainingSlider)();
  (0, _reviewSlider.initReviewSlider)();
  (0, _gallerySlider.initGallerySlider)();
  (0, _video.setPlayVideoClickHandler)();
  (0, _map.initMap)();
...
},{"./modules/form-validate/form":3,"./modules/map":9,"./modules/menu":10,"./modules/nav-link":11,"./modules/section-title":12,"./modules/sliders/feature-slider":13,"./modules/sliders/gallery-slider":14,"./modules/sliders/header-slider":15,"./modules/sliders/review-slider":16,"./modules/sliders/tours-slider":17,"./modules/sliders/training-slider":18,"./modules/video":19,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  if (document.getElementById('map')) {
    ...
    var map = L.map('map').setView([55.77487328280451, 37.6326415], 15);
    // eslint-disable-next-line
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);
    // eslint-disable-next-line
    var marker = new L.Marker([55.77487328280451, 37.6326415]);
    marker.addTo(map);
  }
};
...
var navMain = header ? header.querySelector('.main-nav') : false;
var navToggle = header ? header.querySelector('.main-nav__toggle') : false;
var overlays = document.querySelectorAll('.overlay');
var navLinks = navMain ? navMain.querySelectorAll('.site-list__link') : false;
if (navMain) {
...
var mainFooterNav = footer ? footer.querySelector('.main-nav') : false;
var mainHeaderNav = header ? header.querySelector('.main-nav') : false;
var sections = ['tours', 'training', 'about', 'reviews', 'gallery', 'contacts'];
if (mainHeaderNav) {
  var navLinks = mainHeaderNav.querySelectorAll('.site-list__link');
  if (navLinks.length >= 1) {
    navLinks.forEach(function (navLink) {
      navLink.addEventListener('click', function (evt) {
        evt.preventDefault();
        sections.find(function (section) {
          if (navLink.classList.contains("site-list__link--".concat(section))) {
...
if (mainFooterNav) {
  var _navLinks = mainFooterNav.querySelectorAll('.site-list__link');
  if (_navLinks.length >= 1) {
    _navLinks.forEach(function (navLink) {
      navLink.addEventListener('click', function (evt) {
        evt.preventDefault();
        sections.find(function (section) {
          if (navLink.classList.contains("site-list__link--".concat(section))) {
...
var swiper;
var initFeatureSlider = function initFeatureSlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  swiper = new _swiper.default('.features__slider', {
    // Optional parameters
...
var initGallerySlider = function initGallerySlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default('.gallery__slider', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    // If we need pagination
...
},{"../../vendor/swiper":22}],15:[function(require,module,exports){
"use strict";
...
var initHeaderSlider = function initHeaderSlider() {
  ...
  // eslint-disable-next-line
  var swiper = new _swiper.default(heroSlider, {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    // If we need pagination
  ...
  var heroSlides = heroSlider ? heroSlider.querySelectorAll('.swiper-slide') : false;
  if (heroSlider && heroSlides) {
    heroSlides.forEach(function (item, index) {
      var buttons = item.querySelectorAll('a, button, iframe');
      if (index === activeIndex + 1) {
...
},{"../../vendor/swiper":22}],16:[function(require,module,exports){
"use strict";
...
},{"../../vendor/swiper":22}],17:[function(require,module,exports){
"use strict";
...
exports.initTourSlider = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
// eslint-disable-next-line

var initTourSlider = function initTourSlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default('.tours__slider', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    // If we need pagination
...
exports.initTourSlider = initTourSlider;

},{"../../vendor/swiper":22}],18:[function(require,module,exports){
"use strict";
...
exports.initTrainingSlider = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
// eslint-disable-next-line

var initTrainingSlider = function initTrainingSlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default('.training__slider', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    // If we need pagination
...
exports.initTrainingSlider = initTrainingSlider;

},{"../../vendor/swiper":22}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setPlayVideoClickHandler = void 0;
var video = document.querySelector('.video');
var buttonPlay = document.querySelector('.video__play-button');
...
var setPlayVideoClickHandler = function setPlayVideoClickHandler() {
  if (buttonPlay) {
    buttonPlay.addEventListener('click', createFrame);
  }
};
exports.setPlayVideoClickHandler = setPlayVideoClickHandler;
